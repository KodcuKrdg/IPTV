...
import com.example.kotlincountries.view.CountryFragment
...
class CountryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //"?.Let" değerin içi doluysa çalışacak
        arguments?.let {
    ...
    private fun observeLiveData(){
        viewModel.countryLiveData.observe(viewLifecycleOwner, Observer { country ->
            country?.let {
                dataBinding.selectedCountry = it //-> DataBinding
                ...
                context?.let {
                    countryImage.downloadFromUrl(country.imageUrl, placeHodlerProgressBar(it))
                }*/
